...
## Failure Modes
- Mixed-environment evidence: split evidence collection per environment.
- Wrong route assumption (EKS vs legacy): verify ingress/hostname path first.
...
- 2026-02-26: merged legacy codebase-roots / platform-architecture / deploy-infra-roots details.
